...
RESTCLIENTS_SPS_CONTACTS_CONNECT_TIMEOUT = 3
RESTCLIENTS_SPS_CONTACTS_TIMEOUT = os.getenv("SPS_CONTACTS_TIMEOUT")
RESTCLIENTS_SPS_CONTACTS_POOL_SIZE = os.getenv(RESTCLIENTS_DEFAULT_POOL_SIZE)
...
RESTCLIENTS_SPS_CONTACTS_AUTH_CONNECT_TIMEOUT = 3
RESTCLIENTS_SPS_CONTACTS_AUTH_TIMEOUT = os.getenv("SPS_CONTACTS_TIMEOUT")
RESTCLIENTS_SPS_CONTACTS_AUTH_POOL_SIZE = os.getenv(RESTCLIENTS_DEFAULT_POOL_SIZE)
